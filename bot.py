...
Instalación: pip install python-telegram-bot Pillow
...
# Lista única de prefijos para TODOS los comandos
PREFIJOS = [".", "/", ";", "!", "$", "#", "?", "-"]
...
def es_comando(text: str, comando: str) -> bool:
    """Verifica si el texto es el comando con cualquier prefijo de la lista."""
...
async def handle_all(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ── .gay ─────────────────────────────────────────────────────
        ...
        caption    = f"*Woo\! Eres un total de* `{porcentaje}%` *🏳️‍🌈*"
    ...
    # ── .hetero ──────────────────────────────────────────────────
        ...
        caption    = f"*Eres un* `{porcentaje}%` *Hetero 🏳️*"
    ...
    # ── .pan ─────────────────────────────────────────────────────
        ...
        caption    = f"*Waos\! Eres* `{porcentaje}%` *pansito 🍞*"
